      ...
      <div className="w-full max-w-md bg-secondary/30 p-8 rounded-2xl border border-white/10 shadow-2xl backdrop-blur-sm">
        <div className="flex justify-center mb-8">
          <div className="relative w-40 h-16">
            <Image src="/logo_1.png" alt="Shrimp Zone" fill sizes="(max-width: 768px) 100vw, 200px" className="object-contain" priority />
          </div>
        </div>
        
        <h1 className="text-2xl font-bold text-white text-center mb-8">تسجيل الدخول للإدارة</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            ...
            <input 
              ...
              placeholder="admin@shrimpzone.com"
              dir="ltr"
            />
          </div>
          <div>
